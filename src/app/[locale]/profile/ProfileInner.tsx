    ...
    <>
      ...
      <main className="min-h-screen bg-[#0a0a0a] text-white pt-[120px] px-4 md:px-10 pb-20">
        <div className="max-w-[1300px] mx-auto flex flex-col md:flex-row gap-10">
          {/* Sidebar */}
          <aside className="w-full md:w-[300px] bg-[#0e0e0e]/90 border border-gray-800 rounded-2xl p-6 flex flex-col items-center gap-6 text-center shadow-[0_0_30px_-10px_rgba(250,204,21,0.1)]">
