...
//   // -------------------------------------------------------------------
//   // 1) Load cart from BACKEND (FIXED)
//   // -------------------------------------------------------------------
//   const loadCart = useCallback(async () => {
//     if (!userId) return;
...
//         body: JSON.stringify({
//           userId,
//           id: item.id ?? item._id, // FIXED: backend expects id
//           quantity: newQty,
//         }),
//       });
...
//             <Button
//               className="w-full py-3 rounded-xl bg-gradient-to-r from-[#facc15] to-[#fbbf24] text-black font-semibold text-lg"
//               onClick={() => (window.location.href = "/checkout?step=info")}
//             >
//               Төлбөр төлөх
//             </Button>
//           </div>
