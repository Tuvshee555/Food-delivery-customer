...
export default function TopBar() {
  ...
  return (
    <div className="w-full bg-background border-b border-border text-foreground text-[12px] overflow-hidden">
      <div className="max-w-7xl mx-auto relative flex items-center h-9">
        ...
        <div className="flex-1 overflow-hidden relative">
          ...
          >
            <span className="font-medium tracking-wider uppercase text-muted-foreground px-4">
